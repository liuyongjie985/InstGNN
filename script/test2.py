...
traces_data = []
trace_json = json.load(open(r"10_37_38.json"))
for stroke in trace_json:
    traces_data.append({"label": "connection", "trace_group": [[(int(x["x"]), int(x["y"])) for x in stroke]]})
